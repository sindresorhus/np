...
module.exports = async (input = 'patch', options) => {
	...
	const hasLockFile = fs.existsSync(path.resolve(rootDir, 'yarn.lock')) || fs.existsSync(path.resolve(rootDir, 'package-lock.json')) || fs.existsSync(path.resolve(rootDir, 'npm-shrinkwrap.json'));
