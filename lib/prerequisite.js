...
module.exports = (input, pkg, opts) => {
	...
	const customRegistrySkipMsg = pkg.publishConfig && pkg.publishConfig.registry
		? 'Detected a custom registry'
		: false

	const tasks = [
		{
			title: 'Ping npm registry',
			skip: () => customRegistrySkipMsg,
		...
		},
		{
			...
			skip: () => process.env.NODE_ENV === 'test' || customRegistrySkipMsg,
